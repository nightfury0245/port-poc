  ...
  const data = [
    {
      Year2021: {
        ...
        Average_CO2_emmition_by_a_ship_in_KG:
          Average_Turn_Round_Time_days * Average_CO2_emmition_by_ships * 24,
        Average_CO2_emmition_by_a_ship_in_berth_in_KG:
          Average_stay_at_berth_days * Average_CO2_emmition_by_ships * 24,
        Average_CO2_emmition_by_a_ship_in_working_time_in_KG:
          Average_working_time_days * Average_CO2_emmition_by_ships * 24,
        Average_CO2_emmition_by_a_ship_Pre_berthing_time_Port_Ac_in_days_in_KG:
          Average_Pre_berthing_time_Port_Ac_Days * Average_CO2_emmition_by_ships * 24,
        Average_CO2_emmition_by_a_ship_Preberthing_time_Port_Ac_HRs_in_KG:
          Average_Preberthing_time_Port_Ac__HRs * Average_CO2_emmition_by_ships,
        Average_CO2_emmition_by_a_ship_nonworking_time_days_in_KG:
          Average_nonworking_time_days * Average_CO2_emmition_by_ships_per_hour * 24,
        Total_emmition_by_ship: Average_CO2_emmition_by_a_ship_in_KG * Number_of_cargo_ships,
      },
      Year2020: {
