      ...
      <DashboardLayout>
        ...
        <MDBox mt={8}>
          ...
          <div>
            ...
            <Bar data={generateTechnicalChartData(technicalColors)} />
            ...
            <Bar data={generateEnvironmentalChartData(environmentalColors)} />
            ...
            <Bar data={generateEconomicChartData(economicColors)} />
          </div>
        </MDBox>
      </DashboardLayout>
    </>
